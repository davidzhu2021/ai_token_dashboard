...
def test_static_asset_version_bumped_for_organization_account_claims_release() -> None:
    ...
    assert 'src="/assets/app.js?v=20260804-member-identity-binding"' in markup
    assert "20260804-organization-restore" not in markup
    assert "20260804-pending-adoption" not in markup
    assert "20260803-canonical-model-names" not in markup
